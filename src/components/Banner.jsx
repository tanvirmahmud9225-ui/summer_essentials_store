            ...
            <div className='flex justify-between bg-linear-to-r from-cyan-700 to-blue-950 rounded-lg p-10' >
                <div className='flex-1 items-center flex '>
                    <div className='space-y-6'>
                        <h1 className='text-white font-bold '><span className=' bg-linear-to-l from-cyan-300 to-amber-400 text-transparent bg-clip-text text-8xl italic'>SunCart</span> <span className='text-7xl'>Summer Store</span></h1>
